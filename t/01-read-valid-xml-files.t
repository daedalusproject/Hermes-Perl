...
throws_ok {
    Daedalus::Hermes::_parse_hermes_config(
        "t/files/hermesrabbitnonvalid01.xml");
}
...
throws_ok {
    Daedalus::Hermes::_parse_hermes_config(
        "t/files/hermesrabbitnonvalid02.xml");
}
qr/not well-formed/, "for parsing a file, a valid xml file is needed.";

throws_ok {
    Daedalus::Hermes::_parse_hermes_config(
        "t/files/hermesrabbitnonvalid03.xml");
}
...
throws_ok {
    Daedalus::Hermes::_parse_hermes_config(
        "t/files/hermesrabbitnonvalid04.xml");
}
...
throws_ok {
    Daedalus::Hermes::_parse_hermes_config(
        "t/files/hermesrabbitnonvalid05.xml");
}
...
throws_ok {
    Daedalus::Hermes::_parse_hermes_config(
        "t/files/hermesrabbitnonvalid06.xml");
}
...
throws_ok {
    Daedalus::Hermes::_parse_hermes_config(
        "t/files/hermesrabbitnonvalid07.xml");
}
...
throws_ok {
    Daedalus::Hermes::_parse_hermes_config(
        "t/files/hermesrabbitnonvalid08.xml");
}
...
throws_ok {
    Daedalus::Hermes::_parse_hermes_config(
        "t/files/hermesrabbitnonvalid09.xml");
}
...
throws_ok {
    Daedalus::Hermes::_parse_hermes_config(
        "t/files/hermesrabbitnonvalid10.xml");
}
